...
\(\frac{\ppr{+}{\textit{E=seen} \vert \textit{H=present}}}{\ppr{+}{\textit{E=seen} \vert \textit{H=absent}}}=\frac{.65}{.45}\approx 1.44\).\footnote{The
  ...
  &= .4 \times .5 +.5 *.5 = .45 
  \end{align*}}\todo{Need a more general argument here} So, mere
...
condition like (C*).\todo{Add quasi proof to demonstrate that.}
...
refinement\todo{check that it is under their defintion}, the old and new
...
nodes shared before and after awareness growth.\todo{gove proof of this}
