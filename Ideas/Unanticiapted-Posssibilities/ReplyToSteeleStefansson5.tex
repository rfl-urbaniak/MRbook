...
Bayesianism, we begin with our own. This will allow to underscore the
role of structural assumption in theorizing about awareness growth.
...
In this scenario, you do not learn anything specific. You do not learn
that the lighting condition were bad or that they were good. You simply
wonder about them. So there is no Bayesian updating in the strict sense,
although clearly some new information has been added, namely that
lighting conditions could affect one's sensory experience.\footnote{HERE
  EXPLAIN DIFFERENCE WITH STEELE AND STEFANSSON. The process of
  awareness growth in \textsc{Lighting} adds only one extra variable,
  lighting conditions, while \textsc{Movies} adds two extra variables,
  language difficulty and whether the owner is simple-minded or not.
  Further, \textsc{Movies} contains a clear-cut case of learning, that
...
It is not clear what one should do in this scenario, so we are looking
for a theory that could give us appropriate guidance. We rely on the
theory of Bayesian networks and shows that this scenario challenges
Reverse Bayesianism.
