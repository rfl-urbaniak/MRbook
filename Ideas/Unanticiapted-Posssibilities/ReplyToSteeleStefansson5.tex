...
not involve any change in the structure, the constraint should all for
all cases of expansion thus defined.
...
expansion and do not violate constraint (C).
...
1:2 (after awareness growth).\footnote{ Here is more involved argument.
  ...
  change.} At the same time, much like \textsc{Friends}, this scenario
need not be a challenge for Awareness Rigidity.\footnote{Much depend on
  the choice of the proposition \(T^*\) that picks out, from the vantage
