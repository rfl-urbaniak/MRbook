...
\& Stefánsson (2021) argue that Reverse Bayesianism, when suitably
formulated, can work in a limited class of cases, what they call
\textit{awareness expansion}, but cannot work for
\textit{awareness refinement} (more on this distinction later). Their
argument rests on a number of ingenious counterexamples.
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.3\textheight]{ReplyToSteeleStefansson3_files/figure-latex/heDAG-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.1\textheight]{ReplyToSteeleStefansson3_files/figure-latex/lighting2DAG-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.3\textheight]{ReplyToSteeleStefansson3_files/figure-latex/veracityDAG-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.3\textheight]{ReplyToSteeleStefansson3_files/figure-latex/tailsDAG-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.3\textheight]{ReplyToSteeleStefansson3_files/figure-latex/tenantsDAG-1} \end{center}
