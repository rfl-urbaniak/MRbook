...
### Steele and Stafansson: awareness growth
...
basic and inconsistent, their probability ratio in the old algebra,$P(A)/P(B)$, should be the same as ijn the new algebra, so $P(A)/P(B)=P^+(A)/P^+(B)$, where $P^+$ is a probability function 
over a an expanded or refined albegra of propositions. This is a sort of conservative principle.
