...
the number of claims under consideration increases. Say a piece of
evidence \(E_1\) defeasibly suports claim \(C_1\); \(E_2\) defeasibly
supports claim \(C_2\); and so. Each of these relationships of
evidential support could be undercut by defeaters \(D_1\), \(D_2\), and
so on. Suppose the pieces of evidence are combined into the conjunction
...
\(C_1 \wedge C_2 \wedge \dots \wedge C_k\) could be attacjed by a larger
...
the sake of argument, however, suppose the legal probabilist rejects the
