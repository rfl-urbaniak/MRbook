...
A limitation of thr analysys offerred so far if that it only considers
the costs of mistaken decisions, but leaves out the benefits associated
with correct decisions. More comprehensive analyses would consider both,
but the basic insight would remain the same (Laudan, 2016). Trial
decision-making is viewed as one instrument among others for maximizing
overall social welfare (Dekay, 1996; Posner, 1973).

For the sake of completeness, consider costs and benefits of trial
decisions. For simplicity, we will quantify them by units of utility,
where benefits will be positive numbers and costs negative numbers In a
criminal trial, the following costs, should be assessed: \(\ut(CI)\)
and\(\ut(AG)\), as well as the following benefits: \(\ut(CG)\) and
\(\ut(AI)\). On this more complex analysis, a conviction is justified
provided the expected utility of a conviction---that is,
...
RIGHT? DOES THIS MEAN NO THRESHOLD WIL EVER SUFFICE? THIS IS A
