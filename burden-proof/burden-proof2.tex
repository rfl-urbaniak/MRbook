...
quantified, the probability threshold can be determined. By solving for
the probability of guilt, the threshold is identified by the equation:

\[ \pr{G | E} > \frac{1}{1+\frac{\cost(AG)}{\cost(CI)}}\]

For example, suppose mistaken conviction is nine times as costly as a
mistaken acquittal. The corresponding probability threshold will be
90\%. On this reading, in order to meet the standard of proof beyond a
reasonable doubt, the prosecution should provide evidence that
establishes the defendant's guilt with at least 90\% probability, or in
formulas, \(\pr{G | E} > 90\%\). The higher the cost ratio
...
\noindent This analysis only considers the costs of mistaken decisions,
but leaves out the benefits associated with correct decisions. More
comprehensive analyses would consider both, but the basic insight would
remain the same (Dekay, 1996; Laudan, 2016). Trial decision-making is
viewed as one instrument among others for maximizing overall social
welfare (Posner, 1973).

for the sake of completeness, however, consider costs and benefits of
trial decisions. In a criminal trial, let the costs be\(\cost(CI)\) and
\(\cost(AG)\), and let the benefits be \(\benefit(CG)\) and
\(\benefit(AI)\). On this more complex analysis, a conviction is
justified provided the expected utility of a conviction---that is,
\(\pr{I | E } \cdot \cost(CI) + \pr{G | E} \cdot \benefit(CG)\)---exceeds
the expected utility of an acquittal---that is,
\(\pr{G | E} \cdot \cost(AG) + \pr{I | E} \cdot \benefit(AI)\). The
threshold is identified by the equation:

\[ \pr{G | E} > \frac{1}{1+\frac{\benefit(CG)-\cost(AG)}{\benefit(AI)-\cost(CI)}}\]

For simplicity, we are supposing here that costs stand for positive
numbers, while costs stand for negative number. If the benefits of
convictions and acquittals are zero, this equation would boil down to
the earlier equation. Say, if the costs of a mistaken conviction is nine
times the cost of a mistaken acquittal, that is,
\(\frac{\cost{CI}}{\cost{AG}}=9\), while the benefits are zero, the
decision threhshold should be a guilt probability of
\(\frac{1}{(1+(0-1)/(0-9)}=0.9\), as before. Or suppose the magnitude of
the benefits resulting from acquitting an innocent defendant is the same
as the magnitude of the costs resulting from convicting an innocent. Say
the benefit is +9 units of utility (9 units of utility are gained),
while the cost is -9 units of utility (9 units of utility are lost).
Similarly, suppose the magnitude of the benefits resulting from
convicting a guilty defendant is the same as the magnitude of the cost
resulting from acquitting a guilty defendant. Say the benefit is the
acquisition of 1 unit of utility, while the costs is the loss of 1 unit
of utility. Then, once again, the threshold would be
\(\frac{1}{(1+(1+1)/(9+9)}=0.9\), as before.

NEED TO EXPLORE WHAT HAPPEN IF COST AND BENEFITS ARE NOT THE SAME. HOW
...
distinctions, not explictily codified in the law. The law typically
makes coarse distinctions between standards of proof, such as
\texttt{proof\ beyond\ a\ reasonable\ doubt\textquotesingle{}\ for\ criminal\ cases,}preponderance
of the evidence' for civil cases and `clear and convincing evidence' for
a narrow subset of civil cases in which the accusation against the
defendant is particularly serious. But for rather different crimes,
associated with rather different punishments, say murder and grand
theft, the same standard of proof is applied for both. It is not obvioys
why this should be so, except that a finer distinction may cause more
confusion than there need to be. If the probability required for a
conviction or a finding of civil liability against the defendant is a
function of weighing the costs and benefits that would result from true
and false positives (as well as true and false negatives), the
stringency of the threshold should depend on costs and benefits, and
thus different cases may require different thresholds. Cases in which
the charge is more serious than others---say, murder compared to grand
theft---may require higher thresholds so long as the cost of a mistaken
decision against the defendant is more significant. In countries that
allow for the death penalty or life imprisonment for certain crimes but
not others, the cost of a mistaken conviction would be more serious for
crimes with harsher punishments, other things being equal. Thus, the
threhold should be placed appropriately higher. We could even think that
the threhsold should vary across individual cases even for defendants
charged with the exact same crime, provided the costs are different for
different individuals. Needless to say, whether or not standards of
proof should vary in this way is debated (Kaplow, 2012; Picinali, 2013).
Ultimately, the question is what considerations should be admissible in
the calculus of costs and benefits.

Consider the loss resulting from convicting an innocent defendant. This
loss may include: the inappropriate assignment of culpability; loss of
income; severance from family members; putting other citizens at higher
risk of victimization by the actual perpetrator. What about the correct
acquittal of an innocent? There woud be no inappropriate assignment of
culpability; no loss of income; no severance from familiy members. The
actual perpetrator, however, would still potentially victimize others.
What this shows is that there is a significant cost of trying an
innocent defendant, no mater the dfinal decision. It is the cost of
failing to identify the true perpetrator and thus putting other citizens
at potential risk of victimization. This baseline cost of trying an
innocent defedant become even graver when an innocent defendant unjustly
convicted. The costs of trying an innocent at significant, but they
become even higher whne an innocent person is convicted.
