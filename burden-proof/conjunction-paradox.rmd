...
\ali{R: scale down and put them next to each other in a single figure, they take too much space; then avoid referring to figures in a way that depend on their location, as these might shift in the editorial process. Always say things like "In figure \ref{fig:aADAG}".}
