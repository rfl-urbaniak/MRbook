...
We should make the argument here more general and more rigorous. Why should we subscribe to teh two independence assumptions in the aggravated assault case? More generally, what kind of independence assumption should we expect to hold in other cases? Before we proceed any further, we should formally represent with suffucient generality the relationship between claims $A$, $B$ and their conjunction, as well as the supporting evidence $a$, $b$ and their conjunction. The most natural to do that in the language of probability theory is to use Bayesian networks. 
