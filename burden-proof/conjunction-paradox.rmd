...
BASIC IDEA: NAKED STATISTICAL EVIDENCE IS ABOUT LACK OF SPECIFICITY. CONJUCTION PARADOX IS ABOUT LACK OF UNITY. BOTH SPECIFICITY AND UNITY ARE NEEED TO CONSTRUCT NARRATIVES. 
...
Back to the difficulty with conjunction. What triggers the difficulty is that the prosecutor or plaintiff are assumed to establish each element in isolation. If they manage to prove each element to the desired standard, they presumably have meet their burden, or at least this is what the conjunction principle suggests. So, besides conflating the elements of wrongdoing with the way these elements are established in court, the standard formulation of the conjunction paradox makes another conflation. It is one thing to establish that the defendant committed $A$ and committed $B$---where the wrongdoing in question, say assault, is defined in the law as comprising two elements, $A$ and $B$. It is quite another thing to establish that the defendant is guilty of assault. In other words, guilt---and the same applies to civil liability---is not the mere conjunction of generic claims corresponding to the elements of wrongdoing as defined in the law. What is it, then? Guilt is a state of affairs that is described by a well-specified series of events that possess a coherent, structured unity. These events, taken as a whole, can be subsumed under the applicable legal definition. 
...
3. DEFEATERS. NARARUIVES OPEN UP POSISBILITIES TO MORE DEFEATERS THAT COULD THEN UNDERMINE AN INDIUVIDUAL CLAIM FOR WHICH ONE MIGHT NOT HAVE CONSIDERED 
A DEFEATER WITHOUT CONSIDERING THE NARRATIVE. 
