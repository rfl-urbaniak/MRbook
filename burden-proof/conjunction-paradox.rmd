...
So basically, we would need to come up with a formal measure of "how hard it is prove something" and this formal measures should capture the "burden of proof" and returns the intuitive results we expect. 
...
PROS. The switch to narratives captures the complexity of proof, different structured claims in relationship of dependence or independence.
