...
for different values of sensitivity and specificity of the evidence. The latter always exceeds the fomer. 
...
ggplot() +
  ...
  theme(legend.position = c(0.9, 0.8), legend.title = element_blank())  + geom_line(aes(x = x, y = y0908,color = "sens=0.9, spec=0.8", lty = "single"))+
geom_line(aes(x = x, y = yy0908,color = "sens=0.9, spec=0.8", lty = "joint"))
...
because $\pr{b \vert a} > \pr{b}$ (assuming, at least, $a$ and $b$ are convergent pieces 
...
equivalent $\pr{B \vert b \wedge a}> \pr{B|a}$ since by Bayes' theorem 
$\pr{B \vert b \wedge a} = \frac{\pr{b |B \wedge a}}{\pr{b|a}} \times \pr{B|a}$.
