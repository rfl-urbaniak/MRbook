...
ratio <- function (x, s1, s2, n){
  postn(x, s2, s2, n)/x^n  }

x <-seq(0,1,by=0.001)
y0908 <- ratio(x, 0.9, 0.8, 1)
y0909 <- ratio(x, 0.99, 0.99, 1)
yy0908 <- ratio(x, 0.9, 0.8, 2)
yy0909 <- ratio(x, 0.99, 0.99, 2)
yynull <- ratio(x, 0.5, 0.5, 2)
y50908 <- ratio(x, 0.9, 0.8, 5)
y50909 <- ratio(x, 0.99, 0.99, 5)
y5null <- ratio(x, 0.5, 0.5, 5)
