...
will show---perhpas surprisingly---that the difficulty about conjuntion
will not go away even after switching from posterior probabilities to
...
\begin{center}\includegraphics[width=0.9\linewidth]{burden-proof3_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{burden-proof3_files/figure-latex/unnamed-chunk-3-1} \end{center}
