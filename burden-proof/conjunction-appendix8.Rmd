...
Now, to obtain a corollary analogous to Corollary \ref{cor:BFind2}, we use the additional assumption that either $\pr{b\vert a} \leq \pr{b}$ or $\pr{a \vert b} \leq \pr{b}$.



\begin{corollary} Suppose \eqref{eq:I4} and \eqref{eq:I5}  hold and $BF_{BA}, BF_{B} >1$. 
Then if either $\pr{b\vert a} \leq \pr{b}$ or \linebreak  $\pr{a \vert b} \leq \pr{b}$, we have $BF_{AB}> BF_{A}, BF_{B}$. \label{cor:BFweaker}
\end{corollary}
