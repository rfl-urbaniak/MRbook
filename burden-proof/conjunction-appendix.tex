...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
relation to conjunction. First, given CONDITIONS, if separate BFs are
greater than 1, then so is the joint BF.
...
The step marked by asterisk rests on the independence assumptions
codified in Figure \ref{fig:conjunctionDAG}, namely: \eqref{eq:indAB},
\eqref{eq:I4}, and \eqref{eq:I5}.{]}
