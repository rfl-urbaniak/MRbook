...
s the number of claims under consideration increases. Say a piece of evidence $E_1$ defeasibly 
...
$C_1 \wedge C_2 \wedge \dots wedge C_k$. While each claim $C_i$ could be attacked by a defeater $D_i$, the conjunction $C_1 \wedge C_2 \wedge \dots \wedge C_k$ could be attacjed by a larger set of defeaters, $D_1$, $D_2$, \dots, $D_k$. So $C_1 \wedge C_2 \wedge \dots \wedge C_k$ is more susceptible to be proven 
...
For the sake of argument, however, suppose the legal probabilist rejects 
