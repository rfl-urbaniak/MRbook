...
Since the combined evidential support
 ...
 assumptions, the difficulty about conjuction disappears so long 
 as evidential support is not formalized in 
 terms of the conditional probability $\pr{H | E}$ but rather in terms of the Bayesian 
