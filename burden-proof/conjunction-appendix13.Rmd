...
## Aggregation can fail if the items of evidence are directly dependent  {-}
...
CPkable2("conjunctionDoubleBNL","a") %>%   
                          kable_styling(latex_options=c("striped","HOLD_position")) 
...
```{r aggregationFails,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%"}
aggregationFailurePlot 
```

\caption{Aggregation fails in 14% cases if there is direct dependence between pieces of evidence even if the individual Bayes factors are greater than 1.}
