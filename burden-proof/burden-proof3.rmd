...
ggplot() +
  stat_function(fun=function(x)(x), geom="line", aes(colour="1, sensitivity=0.5, specificity=0.5"))+
  geom_line(aes(x = x, y = yynull,color = "2, sensitivity=0.5, specificity=0.5")) +
