...
The standard of proof in a civil or criminal trial is a decision
criterion. It answers the question, what characteristics should the
evidence presented at trial possess to judge the defendant civilly or
criminally liable of whatever they were accused? According to some legal
probabilists, a verdict against the defendant is warranted in case the
evidence establishes the defendant's liability with a probability above
a suitable threshold (see Bernoulli, 1713; Dekay, 1996; Kaplan, 1968;
Kaye, 1979; Laplace, 1814; Laudan, 2006). In criminal cases, the bar is
high, and so the threshold will be, say ``at least .95 probability.'' In
civil cases, the bar is lower, and so the threshold will be, say ``at
least .5 probability.''
...
a second theoretical problem: what we will
...
conjunction principle can be extended accordingly. Note that \(a\) and
\(b\) denote the evidence for claims \(A\) and \(B\) respectively, and
\(S\) denotes the standard by which the evidence establishes the claim
in question. So, for example, the expression S{[}\(a, A\){]} should be
read as `evidence \(a\) supports claim \(A\) by standard \(S\).'
...
victim (call this proposition \textsf{injury}). In addition, the fact
that the defendant made a call to an emergency number (call this fact
\textsf{call}) is offered as evidence for the proposition that the
defendant knew he was dealing with a firefighter (call this proposition
...
general? To address this question, we will represent
...
of \(A\) and \(B\), nor the independence of evidence nodes \(a\) and
