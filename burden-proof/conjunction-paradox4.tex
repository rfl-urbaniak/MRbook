...
holds:\footnote{The total evidence \(E\) can be split into two items:
  ...
  The inequality holds in \textsf{DAG1} and \textsf{DAG2}, by replacing
  \(a\) and \(b\) with \(s\) and \(c\) and \(A\) and \(B\) with \(S\)
  and \(C\), because: \begin{align*}
  ...
  \end{align*} The second and third steps in the derivation holds
  because of the independencies in \textsf{DAG1} and \textsf{DAG2}.}\raf{M: I don't think this proof works. The third step does not hold in the Bayesian networks we have.}
