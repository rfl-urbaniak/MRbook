...
elegant. Chapters 11 \todo{REFER TO EARLIER CHAPTER} showed how the .95
and .5 thresholds can be formally justified. But, unfortunately, this
interpretation is not without problems. Chapter 12
...
\ref{sec:difficulty} describes in some detail the contours of the
problem. Sections \ref{sec:strength} and \ref{sec:comparative}
...
Bayesian networks in Chapter 7\todo{REFER TO EARLIER CHAPTER}---affords
...
required probability threshold, it does not necessarily that
...
a simulation we can study how often, in principle, the joint posterior
...
agrees with Schwartz \& Sober (2017) who point out that, if hypotheses
...
ratio---extensively discussed in Chapter 5
...
specificity, and evidential gaps is carried out in Chapter
10.\footnote{An early development of this approach can be found in
...
like---(roughly) it relies on Bayesian
networks.\footnote{More details on this point are in Part III of the
  book devoted to the evaluation and assessment of evidence, especially
  Chapter 7 and 8.}\todo{REF TO OTHER CHAPTERS}
