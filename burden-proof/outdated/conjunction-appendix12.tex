...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-2-1} \end{center}
\subcaption{\textsf{DAG1}}
\end{subfigure}} 
\hspace{5mm}\begin{subfigure}[!ht]{0.45\textwidth}
\vspace{1mm}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-7-1} \end{center}
\subcaption{\textsf{Pipe}}
\end{subfigure} 
\hspace{5mm}\scalebox{1}{\begin{subfigure}[!ht]{0.32\textwidth}
\vspace{1mm}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-8-1} \end{center}
\subcaption{\textsf{Fork}}
\end{subfigure}}
\hspace{5mm}\scalebox{1}{\begin{subfigure}[!ht]{0.32\textwidth}
\vspace{1mm}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-9-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-15-1} \end{center}
\caption{Ca. 25k cases (out of simulated 100k) in which the joint BF is below each of the individual BFs.}
\label{fig:LRfails}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\addcontentsline{toc}{subsection}{Aggregation can fail if the items of
evidence are directly dependent}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix12_files/figure-latex/unnamed-chunk-29-1} \end{center}
\subcaption{Marginal probabilities. }
\end{subfigure}} 
