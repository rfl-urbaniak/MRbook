...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix13_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\addcontentsline{toc}{subsection}{Independencies involved in the
conjunction problem}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix13_files/figure-latex/unnamed-chunk-6-1} \end{center}
