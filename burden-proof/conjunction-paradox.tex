...
>>>>>>> c423faa551c5922f3b049af54d6b1ef73fc525fd
\usepackage{lmodern}
...
Any way to make them more plausible and stremalined? HELP!} The second
...
\(B\).
\todo{M: Not sure how to write this. I used $\ulcorner A\wedge B \urcorner$  to represent the conjunction in the language (as a node in the network) as distinct from 
