...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-2-1} \end{center}
\subcaption{\textsf{DAG1}}
\end{subfigure}} 
\hspace{5mm}\begin{subfigure}[!ht]{0.45\textwidth}
\vspace{1mm}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-7-1} \end{center}
\subcaption{\textsf{Pipe}}
\end{subfigure} 
\hspace{5mm}\scalebox{1}{\begin{subfigure}[!ht]{0.32\textwidth}
\vspace{1mm}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-8-1} \end{center}
\subcaption{\textsf{Fork}}
\end{subfigure}}
\hspace{5mm}\scalebox{1}{\begin{subfigure}[!ht]{0.32\textwidth}
\vspace{1mm}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-9-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/BFind-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/BFind2-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/plotBFDistr-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-15-1} \end{center}
\caption{Ca. 25k cases (out of simulated 100k) in which the joint BF is below each of the individual BFs.}
\label{fig:LRfails}
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-24-1} \end{center}
...
\hypertarget{double-dependency}{%
\subsection{Double dependency}\label{double-dependency}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#graphviz.plot(conjunctionDAG, layout = "dot")}
\FunctionTok{coordinates}\NormalTok{(daggityDoubleDepDAG) }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{( }\AttributeTok{x=}\FunctionTok{c}\NormalTok{(}\AttributeTok{a =} \DecValTok{1}\NormalTok{, }\AttributeTok{A =} \DecValTok{2}\NormalTok{, }\AttributeTok{AB =} \DecValTok{3}\NormalTok{, }\AttributeTok{B =} \DecValTok{4}\NormalTok{, }\AttributeTok{b =} \DecValTok{5}\NormalTok{) ,}
                                            \AttributeTok{y=}\FunctionTok{c}\NormalTok{(}\AttributeTok{a =} \DecValTok{3}\NormalTok{, }\AttributeTok{A =} \DecValTok{1}\NormalTok{, }\AttributeTok{AB =} \DecValTok{2}\NormalTok{, }\AttributeTok{B =} \DecValTok{1}\NormalTok{, }\AttributeTok{b =} \DecValTok{3}\NormalTok{) )}
\FunctionTok{drawdag}\NormalTok{(daggityDoubleDepDAG, }
        \AttributeTok{shapes =}  \FunctionTok{list}\NormalTok{(}\AttributeTok{A =} \StringTok{"c"}\NormalTok{, }\AttributeTok{a =} \StringTok{"c"}\NormalTok{, }\AttributeTok{AB =} \StringTok{"c"}\NormalTok{, }\AttributeTok{B =} \StringTok{"c"}\NormalTok{, }\AttributeTok{b =} \StringTok{"c"}\NormalTok{), }\AttributeTok{radius =} \FloatTok{3.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
A & Pr\\
\midrule
\cellcolor{gray!6}{1} & \cellcolor{gray!6}{0.482}\\
0 & 0.518\\
\bottomrule
\end{tabular}
\end{table}
...
\multicolumn{1}{c}{B} & \multicolumn{2}{c}{A} \\
  & 1 & 0\\
\midrule
\cellcolor{gray!6}{1} & \cellcolor{gray!6}{0.253} & \cellcolor{gray!6}{0.216}\\
0 & 0.747 & 0.784\\
\bottomrule
\end{tabular}
\end{table}
...
\multicolumn{1}{c}{b} & \multicolumn{2}{c}{B} \\
  & 1 & 0\\
\midrule
\cellcolor{gray!6}{1} & \cellcolor{gray!6}{0.701} & \cellcolor{gray!6}{0.352}\\
0 & 0.299 & 0.648\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}\includegraphics[width=1\linewidth]{conjunction-appendix11_files/figure-latex/unnamed-chunk-29-1} \end{center}
\subcaption{Marginal probabilities. }
\end{subfigure}} 
