...
\begin{figure}
```{r plotBFDistr,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%"}
plotBFDistr
```
\caption{Distribution failure for the Bayes factor, \textsf{DAG 1}. The $x$ axis restricted to $(-3,15)$.}
\label{fig:BFdistr}
\end{figure}
