...
of evidential support. For ease of reference, we use the following
abbreviations: \begin{align*}
...
\(BF_{AB}\) toward the conjunction \(A\wedge B\) compares with the
individual supports \(BF_A\) and \(BF_B\) toward the individual claims
\(A\) and \(B\). We prove the following general theorem:
