...
1. The defendant's civil or criminal liability must be sufficiently (or reasonably) high;

2. The narrative, story, theory, explanation that details the defendant's civil or criminal liability should be sufficiently (or reasonably) specific; and  

3. The supporting evidence should be sufficiently (or reasonably) complete

\noindent 
The conjunction paradox no longer arises given this conception of the standards of proof. How so? 
That prosecutors and plaintiffs should aim to establish a well-specified, unified account of the wrongdoing ends up trivializing the conjunction principle and thus dissolving the difficulty about conjunction.  Suppose the prosecutor established a narrative $N$ by a very high probability, say above the required threshold for proof beyond a reasonable doubt. Denote the elements of wrongdoing by $EL_1, EL_2, \dots$. Then, 
