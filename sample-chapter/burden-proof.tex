...
\section{Desiderata for standards of
proof}\label{desiderata-for-standards-of-proof}
...
\todo{Add stuff on thresholds, from Rafal's paper?}
...
\section{Approaching the usual
paradoxes}\label{approaching-the-usual-paradoxes}

\subsection{Cheng's relative legal
probabilism}\label{chengs-relative-legal-probabilism}

\subsection{Kaplow's decision-theoretic legal
probabilism}\label{kaplows-decision-theoretic-legal-probabilism}
