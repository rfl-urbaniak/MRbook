...
et al. (2015) complain, is not about the frequency about their attitude
towards a proposition (supposedly expressing a ``state of nature''),
and, they insist, it makes no sense for an agent to attach uncertainty
to their own uncertainty about a proposition.
...
there is a clear sense in which we can estimate them.\footnote{Taroni et
  ...
  nature because it is a function is not one of them.}
