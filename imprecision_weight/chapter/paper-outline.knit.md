...
<!-- $ y_i \sim norm(\alpha_{\mbox{j[i]}}\, + \beta_{\mbox{j[i]}}   \times  x_i, sigma^2_y ) $  -->
<!-- where $ \alpha_j \sim norm(\mu_\alpha,\sigma_\alpha^2 ) $ and  -->
<!-- $ \beta_j \sim norm(\mu_\beta,\sigma_\beta^2 ) $. Then, running the regression one estimates both the county-level coefficients, and the higher-level parameters. -->
