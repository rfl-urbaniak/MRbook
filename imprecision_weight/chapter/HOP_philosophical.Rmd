---
title: "Higher-order Probability and the precisers-imprecisers impasse"
...
In the literature we  can identify at least two distinctive   ways in which philosophers propose to deploy probabilities to model a rational agent's fallible and evidence-based beliefs about the world.  The first approach,  \textbf{precise probabilism}, posits that an agent's credal state is modeled by a single, precise probability measure. The second approach, \textbf{imprecise probabilism}, replaces precise probabilities by sets of probability measures. Each of these views face difficulties.


We propose an alternative approach, what we call higher-order probabilism, which represents uncertainty by using distributions over parameter values, in line with the usual approach preferred by Bayesian data analysis. We argue that there are good reasons to abandon both precise and imprecise probabilism and endorse higher-order probabilism. 


# The tale of two probabilisms
