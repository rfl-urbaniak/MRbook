...
Consider the (simplified) BN developed by CITE FENTON to illustrate how conviction was unjustified in the Sally Clark case (Figure \ref{fig:scBNplot}). 
...
\begin{figure}[H]
```{r fig:abuse4c,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "100%",   message = FALSE, warning = FALSE, results = FALSE}
abuseExamplePlot
```
