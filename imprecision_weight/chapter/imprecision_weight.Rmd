...
```{r joyceMeasure,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "100%",   message = FALSE, warning = FALSE, results = FALSE}
...
\begin{figure}
```{r joyce1,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "100%",   message = FALSE, warning = FALSE, results = FALSE}
...
```{r joyce2calculations,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "100%",   message = FALSE, warning = FALSE, results = FALSE}
...
\begin{figure}
```{r joyce2,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "100%",   message = FALSE, warning = FALSE, results = FALSE}
...
Putting drastic shift in weights for frequencies not too far from the chance hypotheses, which we already observed, here we see a phenomenon that Figure \ref{fig:joyce1} did not reveal: for frequencies further from the chance hypotheses it seems that penalizing by squaring the distance from the expected values results in a flattening of the shift in weight. 
