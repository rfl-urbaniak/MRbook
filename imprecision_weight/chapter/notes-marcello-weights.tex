...
\hypersetup{
  pdftitle={Marcello's notes on Weight},
  colorlinks=true,
  linkcolor=Maroon,
  filecolor=Maroon,
  citecolor=Blue,
...
evidence.\todo{R: why the same, you can have different conditional probabilities involved?}
...
and\todo{use as motivation for HOP, analogy to Bayesian statistical reasoning with weak prior information.}
...
\todo{I don't think I've seen this paper, would you mind forwarding it to me? Also, a good example of how difficult a practical resilience evaluation is, and how prior weight estimation would help}
