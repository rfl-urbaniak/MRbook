...
on a specific chance hypothesis. He
writes:\todo{Nikodem: fix quotation environment and reference}
...
complicated
manners.\todo{Nikodem: Cite probabilistic progamming without tears here}
What is however somehow surprising is that while the technical devise
has been available, it hasn't been implemented to model agent's
uncertainty, and by the same token to address all the challenging
scenarios we discussed so far.
