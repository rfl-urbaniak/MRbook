...
format:
  pdf:
    ...
    keepTex: true
    toc: true
    include-in-header:  Rafal_latexQuarto.sty
...
```{r FigIinertia2, eval = TRUE, echo=FALSE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%", message= FALSE, warning=FALSE}
...
```{r FigInertia3, echo=FALSE, eval=TRUE,fig.align = "center", cache=TRUE, out.width = "80%",   message = FALSE, warning = FALSE, results = FALSE}
#| fig-pos: 't'
#| label: fig:inertia2
