...
format:
  pdf:
    ...
    keepTex: true
    toc: true
    include-in-header: Rafal_latex7.sty
...
$$
\mathbb{P}_{t_1} = \left\{ \mathsf{P}_{t_1} \, \middle| \, \exists \, \mathsf{P}_{t_0} \in \mathbb{P}_{t_0}, \forall \, H \left[ \mathsf{P}_{t_1}(H) = \mathsf{P}_{t_0}(H \, | \, E) \right] \right\}.
$$
