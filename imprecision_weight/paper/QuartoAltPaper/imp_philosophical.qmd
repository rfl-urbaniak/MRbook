...
probabilists goes something like this @sep-legal-probabilism. \todo{N: Not sure how to cite a section } To evaluate the strength of the two items of match evidence, 
...
Perhaps, the information about sample sizes is good enough  and now you know how to\todo{"Nikodem, cite Taroni in fn." N: not sure if it is the right one} 
...
\todo{Can you google to see if there is any such study? N: failed to find such a study}
