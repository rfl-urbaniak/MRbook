...
the imprecisers already have intuitions about the compatibility of evidence with a probability measure.  The density here can be thought of a more general take on this notion, with the difference that at least in more straightforward cases what shape a density should have given certain evidence and priors is explicitly captured by Bayesian data analysis tools.\todo{added some explanation here, check} 
