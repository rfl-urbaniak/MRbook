...
probabilists\todo{Nikodem: cite standford entry on legal probabilism, section that pertains to likelihood ratios.} 
goes something like this. To evaluate the strength of the two items of match evidence, 
...
hypothesis given a range of possible priors (Figure \ref{fig:impactOfPoint}).  
...
Perhaps, the information about sample sizes is good enough  and now you know how to\todo{Nikodem, cite Taroni in fn.} 
use the evidence properly.^[This is what, effectively, CITE TARONI seem to suggest when they insist 
...
The expert responds with 99% credible intervals---specifically, starting with uniform priors,
 ...
 fur evidence.^[Roughly, the 99\% credible interval is the narrowest interval to which the
  ...
  credible intervals are, how they differ from confidence intervals, and why confidence\todo{Nikodem, cite Kruschke in fn.}
  intervals should not be used, see KRUSCHKE.] With this information, you redo your calculations 
...
We still should think of credible intervals as rough summaries, which  might be useful if
 ...
 But in our case, they might not be. For instance, Figure \ref{fig:densities} depicts beta densities
