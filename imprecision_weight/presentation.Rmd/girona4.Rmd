---
title: A Higher-Order Probabilistic Approach to Imprecision and Weight of Evidence
...
ggplot()+geom_segment(aes(x = .25, y = 0, xend = .25, yend = 1),  color = "skyblue", size = 2)+xlab(expression(theta))+ 
  ylab("probability")+theme(plot.title.position = "plot")+theme_tufte(base_size = 12)+
  theme(legend.position="none")+labs(title = "Fiber frequency", subtitle = "(point estimate)")+xlim(0,1)
```
...
```{r carpetsA,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "90%", warning=FALSE, message = FALSE, dpi = 800}
ps <- seq(0,1,by = 0.01)
...
ggplot(carpetsLong)+geom_line(aes(x = ps, y = value, group = n,  lty = n, color = n))+xlab(expression(theta))+ 
  ...
  theme(legend.position="none")+labs(title = "Fiber frequency", subtitle = "(beta posteriors)")+
...
```{r SCwithHOP, echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "90%", warning=FALSE, message = FALSE, dpi = 800}
SCprobsFinal <- readRDS("../datasets/SCprobsFinal.rds")
attach(SCprobsFinal)
source("../scripts/SCfunctions.R")
source("../scripts/SCplotCPTs.R")
...
- ...are useful for capturing uncertainty

- ...allow for a proper integration of experts'  and statistical evidence

- ...can be used with Bayesian networks


### Next step

- ...can be used to explicate the notion of evidential weight
...
```{r fig:weightsWeird,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "80%",   message = FALSE, warning = FALSE, results = FALSE}
...
<!-- ```{r fig:entropies2,echo=FALSE,eval=TRUE,fig.align = "center", cache=TRUE, fig.show = "hold", out.width = "100%",   message = FALSE, warning = FALSE, results = FALSE} -->
<!-- SCguiltPlotP -->
<!-- ``` -->
