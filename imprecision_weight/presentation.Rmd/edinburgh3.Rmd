...
A bunch of other related limitative results  [@Dietrich2016pooling]
...
```{r goodWEights,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "80%"}
six <- seq(0,10, by = 1)
...
joyce10  <- ggplot(outOf10dfLong)+geom_point(aes(x = successes,
  ...
  labs(title = "Joyce's weights grows slower for opposite evidence",
