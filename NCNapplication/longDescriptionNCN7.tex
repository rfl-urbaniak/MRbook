...
separate scenario node that has all the other as its children; finally,
a node corresponding to the ultimate hypothesis as a child of the
scenario node. Such a model could look like this:
