...
As many miscarriages of justice indicate, scientific evidence is easily misinterpreted in court. This happens partially due to miscommunication  between the parties involved, but also because incorporating scientific evidence in the context of a whole case can be really hard.   
While probabilistic tools for  piecemeal evaluation of scientific evidence in legal contexts are quite well developed,\todo{say sth about replicability crisis in forensic sciences at some point?} the construction of a more general probabilistic model of incorporating such evidence in a wider context of a whole case, and probabilistic explication of legal decision standards, remain a challenge. Methods are needed to  support proper assessment of evidence in such contexts. This project intends to contribute to further developments on such methods in a philosophically motivated manner. 
