...
According to a common probabilistic
interpretation,\mar{R: add some refs?} the standard of proof in legal
trials functions as a probability threshold. In criminal cases the
standard is very stringent, and so the probability threshold should be
high: say the defendant's criminal liability should be established with
at least .95 probability. In civil cases the standard is less stringent,
so the probability threshold should be lower: say the defendant civil
liability should be established with at least .5 probability.

Chapter XX \todo{REFER TO EARLIER CHAPTER} shows how the .95 and .5
thresholds can be argued for by means of expected utility theory.
Chapter YY \todo{REFER TO EARLIER CHAPTER} examines a theoretical
problem for this probabilistic interpretation: the paradox of naked
statistical evidence. This chapter examines another theoretical problem,
which we will \textbf{the difficulty with conjunction}, also known as
\textbf{the conjunction paradox}. The chapter is structured as follows.
First, we describe the difficulty with conjunction. Next, we explore
different strategies that legal probabilists can pursue to respond to
this difficulty. These strategies are promising and worth examining. But
we show that they are ultimately unsatisfactory. Finally, we articulate
our proposal.
...
Stein, 2013; Haack, 2014; Schwartz \& Sober, 2017; Stein, 2005).
...
fails to meet the required standard. Many consider this outcome
counter-intuitive and contrary to trial practice.
\mar{R: any refs here?}
...
conjunction by the same standard. Distribution claims that establishing
...
principle (more on this toward the end of this chapter).
...
captures two desidred features of the standard of proof. The principle
has some degree of plausibility and is consistent with the case law. For
...
So we have a class of cases in which despite condition (i) being
satisfied, (ii) liability as a whole is \textit{not} established by the
requisite standard (assuming a threshold-based probabilistic
interpretation of the standard), which contradicts the conjunction
principle.

In other words, the difficulty with conjunction consists in the fact
that a threshold-based interpretation of the standard of proof violates
the conjunction principle by violating aggregation. Even though
...
probability of each conjunct, considered in isolation, can meet the
...
Nor does the difficulty with conjunction generally subside if the claims
are no longer regarded as independent. The probability of the
conjunction \(A \et B\), without the assumption of independence, equals
...
simplification. As we will see, it is crucial to pay attention to the
supporting evidence and the structure of the problem. With this in mind,
for two claims, the principle can be formulated as follows:
...
\begin{center}\includegraphics{conjunction-paradox3_files/figure-latex/fig:hEDAG-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{conjunction-paradox3_files/figure-latex/fig:aADAG-1} \end{center}
\end{subfigure}\begin{subfigure}[!ht]{0.45\textwidth}

\begin{center}\includegraphics[width=0.6\linewidth]{conjunction-paradox3_files/figure-latex/fig:bBDAG-1} \end{center}
\end{subfigure}
...
\begin{center}\includegraphics[width=0.6\linewidth]{conjunction-paradox3_files/figure-latex/fig:conjunctionDAG-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{conjunction-paradox3_files/figure-latex/fig:conjunctionDAG2-1} \end{center}
...
In fact, we can study how often, in principle, the joint posterior is
below both of the individual posteriors. To this goal, we simulated 10k
random Bayesian networks based on \textsf{DAG 1} and \textsf{DAG 2}.
Here is the distribution of the distance of the joint posterior to the
minimum of the individual posteriors.

\begin{verbatim}
##  [1] "As"                "Bs"                "aifAs"            
##  [4] "aifnAs"            "bifBs"             "bifnBs"           
##  [7] "as"                "bs"                "Aifas"            
## [10] "Bifbs"             "abs"               "abifABs"          
## [13] "abIfnABs"          "ABs"               "ABifabs"          
## [16] "BFAs"              "BFBs"              "BFABs"            
## [19] "LRAs"              "LRBs"              "LRABs"            
## [22] "minIndividual"     "diffIndividualMin"
\end{verbatim}
...
\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/bfconjunction5-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/unnamed-chunk-12-1} \end{center}




\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{conjunction-paradox3_files/figure-latex/unnamed-chunk-18-1} \end{center}
...
\leavevmode\vadjust pre{\hypertarget{ref-penn1993}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-wagenaar1993anchored}{}}%
