...
Condorcet, and Poisson. This led to a research program that now involves
legal scholars, forensic scientists, psychologists, statisticians,
computer scientists and a handful of philosophers.
...
accounts in the literature. We make two main comments. First, other
accounts are not incompatible with legal probabilism 1.02 which may in
fact provide a more rigorous way to express their insights. This point
applies to foundeherentism (Hack), normic support (Smith), argumentation
theory (Sartor and Prakken), the story model (Pennington and Hastie; van
Koppen and Mackor) and to some extent relative plausibility (Allen and
Pardo). The second point we make is that much of the literature in legal
epistemology has paid little attention to the values and
objectives---such as improving accuracy and ensuring fair
decisions---that should guide the design and evaluation of the justice
system. To be sure, this criticism can also be leveled against legal
probabilism. Admittedly, there is no empirical evidence that a
probabilistic turn would improve the accuracy and fairness of trial
decisions, also because how these improvements should be measured is
unclear. `Probability on Trial' tackles this normative question in the
final part.
...
\item
  ...
  accompanied by mathematical proofs and \textbf{\textsf{R}} code. We
  will also rely on Branden Fitelson's \textbf{\textsf{PrSAT}} which
  offers a decision procedure for the probability calculus. This
...
international conferences in the coming years. We were invited speakers
at an international conference on Evidence Law in Girona, Spain in
Spring 2022. This conference gathers some of the leading scholars in
...
have also been invited to other international conferences in legal
philosophy in Fall 2022 and Spring 2023.
