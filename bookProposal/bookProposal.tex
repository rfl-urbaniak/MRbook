...
book boosts legal probabilism to its limits. We first examine the
simpler version of the theory, legal probabilism 1.01, which falls prey
to several difficulties, including the problem of conjunction, puzzles
of naked statistical evidence, the problem of priors. We show that these
difficulties cannot be addressed within the limited framework of legal
probabilism 1.01. We then develop a more sophisticated version of the
theory, legal probabilism 1.02, which deploys Bayesian networks and
...
probabilism 1.01. We show that the more sophisticated version
significantly improves on the simpler version and rivals in explanatory
