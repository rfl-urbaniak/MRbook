...
This book contributes to the development of legal probabilism by
formulating its variant that accomodates important insights provided by
its critics. A crucial point of criticism is that the fact-finding
process should be conceptualized as a competition of narrations. We
...
narrations are represented as bayesian networks, various criteria on,
features of and operations on narrations can be explicated in terms of
corresponding properties of and operations on bayesian networks. The
conceptual developments are accompanied by technical accounts, and
...
them (rather than simply focusing on abstract philosophical thought
experiments) the reader can develop a proper assessment of the
situation.

One key feature of the book that makes it unique is that it is
multi-faceted in its incorporation of insights from various discussions
present in legal, philosophical, and forensic research, and in its
implementation of the conceptual points by means of bayesian networks
and \textbf{\textsf{R}} programming language.
