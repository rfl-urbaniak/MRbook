...
objections.\todo{Added this bit on normativity, not sure if it should be here or later, take a look.}
...
\todo{added bit on background causal knowledge, take a look} that
