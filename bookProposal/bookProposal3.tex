...
simple version of legal probabilism \todo{awkward phrase here:} has much
to be reccomeded for, but also falls prey to several difficulties,
including the problem of conjunction, puzzles of naked statistical
evidence, or the problem of priors. Some legal probabilists have
attempted to dismiss these difficulties or downplay their significance.
We confront them at face value and show that they cannot be addressed
within the confines of simple legal probabilism. We then develop a more
sophisticated theory, what we call legal probabilism 1.02, which takes
advatange of Bayesian networks and other seminal ideas in the literature
...
overcome the limitations of simple legal probabilism.
\todo{I had problems parsing this sentence, rewrite:} We show that the
...
Bayesianism in epistemology. The book will also
\todo{This sounds awkward, rewrite:} draw attention outside philosophy
from legal scholars who have championed applications of probability
theory to evidence law as well as scholars who have resisted this trend.
Another target audience includes computer scientists and psychologists
...
\todo{This is a bit too strong, rephrase:} cannot model the notion of
...
\todo{please remember to use dashes like this} facts---for example,
...
fetichism'---that is, they borrow ideas that are popular in contemporary
analytic epistemology and force them onto legal-decision making. This
criticism applies in particular to knowledge accounts of legal
proof.\todo{How do we avoid probability fetishism though, one might ask?}
...
decision-making at trial, it can still play an analytical role in
theorizing about trial decisions The fourth part of the book illustrates
this point by discussing two important legaal values that should inform
trial proceedings: accuracy and fairness.
...
accurate, this claim leaves open what we mean by `accuracy' There are in
fact several distinct ways to understand accuracy in trial decisions,
and probability theory offers a language to formulate them.
\todo{As I said, this paragraph seems too hasty:} Accuracy can be
understood, among other things, as predictive accuracy or diagnostic
accuracy. The former is the probability that if the defedant is found
(not) liable at trial, the defendant is actually (not) liable; the
latter is the probability that if the defendant is (not) liable, the
defendant would (not) be found liable at trial. The two notions are
related but they are not equivalent. Distinguishing them has
