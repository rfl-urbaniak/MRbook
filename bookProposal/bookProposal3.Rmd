...
\todo{Added this short description of parts, as requested bo Sophie. Check.}

The book is divided into three chapter clusters. Part I covers the current state of legal probabilism and the challenges it has faced. Part II introduces and motivates the philosophical moves and formal choices that we will make later on, by a focused discussion of the  key formal tools used by legal probabilism so far and the issues that come up with their deployment in legal fact-finding. In Part III we develop our own approach and motivate it from the epistemological perspective. Part IV is devoted to a decision-theoretic perspective on  our approach. Part V focuses on accuracy and fairness considerations, as pertinent to our approach.
...
\textbf{Chapter 10} draws some general morals after comparing legal probabilism 1.02---as formulated in the 
