...
have alleged, is that likelihood ratios \todo{This is a bit too strong, rephrase:} cannot 
...
its ability to withstand objections. In the following chapters, 
we show that our proposal outperforms the comparative strategy and 
the likelihood ratio strategy. We emphasize that these 
criteria---probability, specificity, etc. 
-- can be modeled using Bayesian networks. So our proposal
lies within the confines of legal probabilism, though not 
the narrow version its critics have in mind. 
...
the evidence and the alleged \todo{please remember to use dashes like this} facts---for example, information about the 
