...
The calculation of the weights for the distributions in @fig-weightDemo1 is as follows:

\begin{align*}
&W(\text{uniform}) = \text{`r round(priorWeightR, 2)`} \\
&W(\text{post Beta(2, 2)}) = \text{`r round(posterior_2WeightR, 2)`} \\
&W(\text{post Beta(501, 501)}) = \text{`r round(posterior_1000WeightR, 2)`}
\end{align*}
...
\begin{align*}
&\Delta W(\text{post Beta(501, 501)}, \text{post Beta(2, 2)}) = \text{`r round(posterior_1000WeightR, 2)`} - \text{`r round(posterior_2WeightR, 2)`}\\
\end{align*}
...
\begin{align*}
&\Delta W(\text{post Beta(501, 501)}, \text{post Beta(2, 2)}) = \frac{\text{`r round(posterior_1000WeightR, 2)`}}{\text{`r round(posterior_2WeightR, 2)`}}\\
\end{align*}
