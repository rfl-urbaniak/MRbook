...
\todo{M: Is this derivation from Thompson and Taroni? Clarify}
...
\todo{M: Compare this LR with other formules, for example, by Buckelton and plot them one against the other to see how/if they differ.}
