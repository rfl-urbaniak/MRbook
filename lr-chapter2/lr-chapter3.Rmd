...
Also in experimental setting (where the witnesses are less emotionally affected by the crime), eyewitnesses identify a   filler in approximately twenty percent of all real criminal line-ups \citep{thompson2007beyond}.
...
Information about all the factors we disussed, plugged into an appropriate multivariate model based obtained in an approriate statistical analysis or meta-analysis) does lead to  quantitative estimates, including some estimation of the uncertainty involved, such as confidence intervals.  If you think an untrained jury member can do better by just intuitively evaluating what the eyewitness said instead, we disagree.
