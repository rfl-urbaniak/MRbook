...
some have suggested \todo{add references}, the relevant error
...
sharp divide between quantitative and non-quantitative evidence. The
statement that the crime scene DNA matches the defendant's DNA is
qualitative, but its value is best assessed by means of numerical
information, such as error rates and the random match probability.
Similarly, a witness testifying `I saw him!' carries a lot of weight in
a court of law, but again, its value is best assessed by means of
numerical information, such as data about the risks of a false
identification. These risks should not be downplayed nor exaggerated. As
we will show, quantitative information can be used to this effect and
can be combined in a principled manner in the likelihood ratio.
...
exonerations in the years 1989-2003 shows that around 90\% of false
...
of a specific eyewitness identification, not in general.

Cross-examination is often thought to be the tool for an individualized
assessment of the risk of error.\footnote{The evidence law scholars
  Henry Wigmore in his monumental treatise on the law of evidence
  famously asserted that `cross-examination is greatest legal engine
  ever invented for the discovery of truth.' This assertion, however,
...
eyewitnesses to determine whether they made accurate or mistaken
...
sample of \(48\) witnesses was cross-examined. Subjects (\(n = 96\))
viewing the cross-examination showed little ability to distinguish
accurate from false identifications (Lindsay, Wells, \& Rumpel, 1981).
...
identified someone prior to the line-up; etc. Instead, estimator
variables refer to environmental conditions. The ability of a witness to
make correct identifications is impaired by brief exposure, poor
visibility (bad lighting or long distance) and a long interval between
the first exposure and the moment of recollection. Other factors include
the race of the alleged perpetrator (cross-racial identifications tend
to be less reliable), stress (high stress can lead to worse memory), and
weapon focus (the presence of a weapon leads to an impaired ability to
recognize the perpetrator).

A growing body of research in psychology has began to quantify the
effects of estimator variables on people's ability of recognizing faces.
According to a recent study (see Figure \ref{eyewitness-distance}), the
ratio of hits to false alarms is (roughly) 75\% to 15\% at 0 yard
distance; 70\% to 20\% at 10 yard distance; 65\% to 25\% at 20 yard
distance; 60\% to 30\% at 30 yard distance; 55\% to 35\% at 40 yard
distance \citep{lampinen2014}. \todo{add reference} These numbers can be
used to fill in the conditional probabilities in the likelihood ratio
for an eyewitness identification. Let \(\textsf{id}\) be the statement
the the witness identifies the defendant as the person present at the
scene, and let \(\textsf{presence}\) denotes the fact that the witness
was actually at the scene. The likelihood ratio of interest would look
like this:
\[\frac{\pr{\textsf{id} \vert \textsf{presence}}}{\pr{\textsf{id} \vert \neg \textsf{presence}}}\]

\noindent Depending on the distance, different numbers can be plugged
into the numerator and the denominator. If, for example, the distance is
10 yards, the numerator should be .7 and the denominator 0.2. Thus, the
likelihood ratio would be 3.5, an indication that the eyewitness
identification is probative evidence but its value is somewhat limited.
This analysts is, of course, rather elementary and it is offered as
illustrative. More-fine grained quantitative data are needed so that the
different environmental conditions can be taked into consideration, such
as distance, lighting, stress level,weapon focus, etc.
...
departments run their lineups in pristine conditions. But, as it turns
...
To illustrate, consider two scenarios in which we numerically estimate
the reliability of eyewitness testimony in line with the research we
just discussed. In one, such an expert recognizes the identification
...
(\(\pr{E \vert \n H}\)) is \(.1\pm .03\). In the second scenario, the
...
case-specific assessment of the risks of false eyewitness identification
can be carried out by taking into account estimator and system
...
arrive at a better assessment of the risks of error involved. The
approach we are advocating is continuous with the practice of
cross-examination as tool to detect false identifications. Questions
about time of day, distance, stress level, etc. elicit information about
estimator variables as well as system variables. Empirical research on
...
false identification? So numerical information is likely to strengthen
the role and effectiveness of cross-examination, not replace it.
...
match. When the two conflict---say eyewitness evidence is exculpatory
and the DNA match is incriminating---which should prevail? It is
tempting to reason thus. Since DNA evidence is scientific, it is
stronger evidence and thus should trump eyewitness evidence. We argue
against these blanketed statements. Whether exculpatory eyewitness
testimony is sufficient to acquit in light of incriminating DNA evidence
depends on the particulars: both on the quality of the eyewitness
testimony and on the realistic assessment of the likelihood ratio for
the DNA evidence (incorporating the probability of false positives). The
devil is in the detail.

As an illustration, consider the case People v. Rush, 165 Misc. 2d 821
(N.Y.~Sup.~Ct.~1995) . A rape victim identified the defendant from a
photograph a few weeks after the event. She also identified the
defendant in a line-up two weeks later. At trial, however, she
identified a spectator as her assailant, not the defendant. So, the
eyewitness evidence was ultimately exculpatory. The defendant was seen
in the vicinity of the crime scene three days prior. A DNA expert
testified to a positive match between the crime scene genetic material
and the defendant. The expert also testified that the random match
probability was 1 in 500 million. Confronted with the question whether
to believe the exculpatory eyewitness testimony or the incriminating DNA
match, the court---somewhat emphatically---wrote:
...
What are we to make of this statement? In light of our discussion, this
decision is surprising. The specific circumstances of the first
eyewitness identifications are not examined by the court in sufficient
detail. We would need to know how much the two identifications departed
from pristine conditions and in what respects. The same applies to the
third testimony, when the defendant identifies a person the courtroom as
her perpetrator. Perhaps we should give little weigh to this testimony.
Without any further details, it is hard to make a determination. The
court seems to give almost no weight to the eyewitness testimonies,
whether they are incriminating or exculpatory. For the sake of argument,
let's follow the court in this exercise. The court framed the question
as one of whether A DNA match alone can be enough to sustain a
conviction. Now, aramdom match probability of 1 over 500 million,
correspond to a likelihood ratio of 20 (if the false positive
probability is .05) and 99 (if the false positive probability is 0.1).
Are these number enough to warrant a conviction? If teh prior
probability is about if gulty is about 10\% (a quite high starting point
already), the posterior probability of guilt would only 90\% if the
false positive probability is as as low as 1\%. The posterior would be
even lower, 66\%, if the false positive probability reaches 5\%. These
numbers should give us pause and doubt the decision of the court. And
these relatively low probability do not take into account the
exculpatory value of the eyewitness testimony. Say we given the third
eyewitness testimony an exculpatory value of 0.5. This would enough to
bring the posterior probability of guilt further below to 83\% and 50\%
respectively, a far cry for what is needed to convict an individual.

We do not intend these remark to show that the court was wrong. It had
better access to the trial record and could better evaluate the specific
circumstances of the case. Our point is twofold. First, the random match
probability was fairly low, but exclusively rely on it was a mistake
Doubts remain about the false positive probability, which can have a
significant impact on the value of an incriminating match. Second, the
exculpatory eyewitness testimony might have a very low value, but it
might still be enough to weaken the incriminating DNA match to create a
reasonable doubt. The court seems to have committed the mistake---at
least conceptually---that since the balance of the evidence tips against
the accused, this was enough to convict. While might be true in civil
case, it certainly is true for a criminal case. We will return to this
pint when we discussion the standard of proof.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{priorOdds }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\DecValTok{10}
\NormalTok{rmp }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\DecValTok{500000000}
\NormalTok{fpp }\OtherTok{\textless{}{-}} \FloatTok{0.01}
\DecValTok{1}\SpecialCharTok{/}\NormalTok{((rmp}\SpecialCharTok{+}\NormalTok{fpp}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{rmp)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lr }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{((rmp}\SpecialCharTok{+}\NormalTok{fpp}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{rmp)))}

\NormalTok{postOdds }\OtherTok{\textless{}{-}}\NormalTok{ lr}\SpecialCharTok{*}\NormalTok{priorOdds}
\NormalTok{posteriorProb }\OtherTok{\textless{}{-}}\NormalTok{ postOdds}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{postOdds)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{postOdds }\OtherTok{\textless{}{-}} \FloatTok{0.5}\SpecialCharTok{*}\NormalTok{lr}\SpecialCharTok{*}\NormalTok{priorOdds}
\NormalTok{posteriorProb }\OtherTok{\textless{}{-}}\NormalTok{ postOdds}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{postOdds)}
\NormalTok{posteriorProb}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fpp }\OtherTok{\textless{}{-}} \FloatTok{0.05}
\DecValTok{1}\SpecialCharTok{/}\NormalTok{((rmp}\SpecialCharTok{+}\NormalTok{fpp}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{rmp)))}
\end{Highlighting}
\end{Shaded}
