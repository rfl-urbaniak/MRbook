...
\ref{sec:fp} we given an example of its utility. We explain the reasons
to take the risk of false positives and use likelihood ratio to
illustrate the impact of such a risk on the value of DNA evidence.
...
for various selection of hypotheses at play, and so a readable
...
Then we go over a debate about the value of cold-hit DNA matches in
which various agencies studying or performing DNA evaluation have still
failed to reach agreement (Section \ref{sec:coldHitConfusion}), and
argue that a proper use of likelihood ratios leads to a fairly clear
resolution (Section \ref{sec:cold-hit}).
