...
probabilistically irrelevant to
the\mar{R: added fn about irrelevant conjunction papers.} original
...
requires more information than the calculation\mar{R: check new fn} of
...
both advantages and limitations of the likelihood ratio as a measure of
evidential strength is the two-stain problem, originally formulated by
...
of the likelihood ratios in the judging of a whole case requires a more
