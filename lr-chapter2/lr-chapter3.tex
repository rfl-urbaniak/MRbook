...
probability that the defendant is the source is roughly \(.17\). This
...
the impact the evidence on the posterior probability? Following Di Bello
\& Verheij (2018), we can distinguish between the overall global value
of the evidence and more local incremental support. The former is more
directly connected with the ultimate decision we would like to make: if
...
\(\pr{H \vert E_1, \dots, E_n}\). This notion, however, is not very
useful when it comes to the evaluation of the impact of an individual
piece of evidence on the probability of the hypothesis. After all, if a
piece of evidence shifts the probability of the hypothesis say, from
\(.00007\) to \(.007\), the posterior is still very low, but the impact
of the evidence is quite strong. Moreover, various witnesses and experts
provide various pieces of evidence, and a sensible assessment of the
value of these pieces should precede the aggregation of these pieces
into a whole, complex case, and so a local notion of evidential strength
is needed.
...
hypothesis) (CGG Aitken et al., 2010, p. 38).
...
few probabilistic confirmation measures in the vicinity and might wonder
why almost none of them were discussed in the chapter, in Appendix
...
match is reported if it does. Mind your head: here \(E\) stands for
error, not for evidence! In terms of our notation, we have:
\begin{align*}
...
Colin Aitken et al. (2003) if we take \(e\) to be FPP, as we should on
...
easily manipulable---measure of evidential value.
...
are insufficiently informative). Suppose two stains from two different
sources were left at the crime scene, and the suspect's blood matches
one of them. More precisely, the two items of evidence are as follows:
\vspace{2mm}
...
1996; Taroni et al., 2014): \begin{align*}
...
Some unity can be brought into the picture (Crupi et al., 2007) by
normalizing by what happens with a measure where logical consequence or
exclusion is involved. For instance, if \(E \vert T\),
\(D(E,T)=\pr{\n T}\) and if \(E\vert \n T\), \(D(E,T) = - \pr{T}\). So
...
\leavevmode\vadjust pre{\hypertarget{ref-aitken2003probability}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-balding1996EvaluatingDNAProfilea}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Barnett2020Why}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-bolinger2020individualized}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-brennan2012ethics}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Cook1998hierarchy}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dawid1994island}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dawid1996CoherentAnalysisForensic}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dawid2001CommentStockmarrLikelihood}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-brennan_lomasky_1993}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-donnelly1995NonindependenceMatchesDifferent}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-donnelly1999DNADatabaseSearches}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-eggleston1978evidence}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-finkelstein2009basic}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-foreman2003interpreting}{}}%
Foreman, L., Champod, C., Evett, I. W., Lambert, J., Pope, S., et al.
(2003). Interpreting DNA evidence: A review. \emph{International
Statistical Review}, \emph{71}(3), 473--495. International Statistical
Institute.

\leavevmode\vadjust pre{\hypertarget{ref-gelman2002mathematics}{}}%
Gelman, A., Katz, J. N., \& Tuerlinckx, F. (2002). The mathematics and
statistics of voting power. \emph{Statistical Science}, 420--435. JSTOR.

\leavevmode\vadjust pre{\hypertarget{ref-gelman1998estimating}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-meester2004ResponseDawidBalding}{}}%
Meester, R., \& Sjerps, M. (2004b). Response to {Dawid}, {Balding},
{Triggs} and {Buckleton}. \emph{Law, Probability and Risk}, \emph{3}(1),
83--86.

\leavevmode\vadjust pre{\hypertarget{ref-mulligan2003empirical}{}}%
Mulligan, C. B., \& Hunter, C. G. (2003). The empirical frequency of a
pivotal vote. \emph{Public Choice}, \emph{116}(1), 31--54. Springer.

\leavevmode\vadjust pre{\hypertarget{ref-NRCI1992}{}}%
National Research Council. (1992). \emph{{DNA} technology in forensic
science \mbox{\emph{[NRC I]}}}. Committee on {DNA} technology in
{F}orensic {S}cience, {N}ational {R}esearch {C}ouncil.

\leavevmode\vadjust pre{\hypertarget{ref-NRCII1996}{}}%
National Research Council. (1996). \emph{The evaluation of forensic
{DNA} evidence \mbox{\emph{[NRC II]}}}. Committee on {DNA} technology in
{F}orensic {S}cience, {N}ational {R}esearch {C}ouncil.

\leavevmode\vadjust pre{\hypertarget{ref-niedermeierEtAl1999}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-redmayne2008exploring}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Smith2018evidence}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-stockmarr1999LikelihoodRatiosEvaluating}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-thomson1986liability}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-wells1992naked}{}}%
