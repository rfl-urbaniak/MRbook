...
is stronger or weaker evidence than a DNA match. This will allow us to apply what we have learned about match evidence (previous section) as well as eyewitness testimony (this section). When the two conflict---say eyewitness evidence is exculpatory and the DNA match is incriminating---which should prevail? It is tempting to take a clear-cut position. For example, one could reason that, since DNA evidence is scientific, it is stronger evidence and thus should trump eyewitness evidence. We argue against these blanketed statements. Whether exculpatory eyewitness testimony is sufficient to acquit in light of incriminating DNA evidence depends on the particulars: both on the quality of the eyewitness testimony and on a careful assessment of the likelihood ratio for the DNA match (incorporating the probability of false positives). The devil is in the details. 
